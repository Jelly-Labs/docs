## How to create a Weighted Pool on Jellyverse?
...
const createTx = await weightedPoolFactoryContract.create(
    name,
    symbol,
    tokens,
    normalizedWeights,
...
// Address of user who wants to create pool
const owner = "0xPOOL_OWNER_ADDRESS";

// Rate provider is 0x00000...000
const rateProviders = ethers.constants.AddressZero;
